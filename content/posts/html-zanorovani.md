...
description: "Jak funguje zanořování značek jako <code>&lt;p></code> nebo <code>&lt;button></code> v HTML parseru versus DOM metodách."
date: "2025-11-11"
...
<p>Parser při zjištění otevírací značky <code>&lt;p></code> uvnitř jiného <code>&lt;p></code> automaticky <b>uzavře</b> vnější odstavec. Poslední zavírací značka <code>&lt;/p></code> pak vytvoří <b>prázdný odstavec</b>, protože nemá co uzavírat.</p>
...
<p><img src="/files/html-zanorovani/vnoreny-odstavec.png" class="border" alt="Vnořený odstavec v DevTools" /></p>

<p><a href="https://kod.djpw.cz/anod">Živá ukázka</a></p>
...
<ol>
  <li><b>HTML parser</b> zpracovává textový řetězec a podle <b>HTML specifikace</b> musí nevalidní struktury opravit. Parser <i>ví</i>, že <code>&lt;p></code> nemůže obsahovat další <code>&lt;p></code>, a automaticky první uzavře.</li>
...
<p><a href="https://kod.djpw.cz/bnod">Živá ukázka</a></p>

<p>Vypadá to vskutku zajímavě:</p>

<p><img src="/files/html-zanorovani/zanorene-tlacitko.png" class="border" alt="Zanořené tlačítko" /></p>
...
<p>Některé frameworky (např. <b>Svelte</b>) generují kód, který používá DOM metody. To znamená, že mohou vytvořit HTML struktury, které by v čistém HTML nešly napsat.</p>
...
<ul>
  <li>Může to způsobit <b>nekonsistentní chování</b> při různých způsobech renderování (CSR – klientské vs. SSR – serverové)</li>
  <li>Validátory HTML budou hlásit <b>chyby</b></li>
  <li>Může to ovlivnit <b>přístupnost</b> (screen readery mohou mít problémy)</li>
  <li>Budoucí verse prohlížečů mohou takové struktury <b>opravovat</b></li>
</ul>
...
<p>Takže tento nesmyslný selektor bude fungovat:</p>
...
<p>U tlačítek je situace ještě komplikovanější. Tlačítko má speciální <b>výchozí styly</b> a chování (kursor, hover stavy, focus). Vnořené tlačítko zdědí některé vlastnosti, ale může mít problémy s:</p>

<ul>
  <li><b>Kliknutím</b> – které tlačítko se má aktivovat?</li>
  <li><b>Focus stavem</b> – může dojít k neočekávanému visuálnímu zvýraznění</li>
...
<p>Teoreticky jde problém obejít použitím <code>&lt;span role="button" onclick=""></code> a CSS pro stylování, ale lepší řešení je většinou do sebe tlačítka nezanořovat.</p>

<p>Visuálně jde efektu tlačítka v tlačítku docílit absolutním posicováním.</p>
