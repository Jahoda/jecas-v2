...
<p>Prompt injection je technika, při které útočník vloží do vstupu speciálně formulovaný text, který přepíše nebo obejde systémové instrukce modelu. Princip je podobný <a href="/bezpecnost#sql-injection">SQL injection</a> – místo databáze se ale útočí na jazykový model.</p>
