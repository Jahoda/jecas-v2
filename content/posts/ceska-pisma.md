...
<style>
  .pismo {float: left; height: 8em; width: 25%; width: -webkit-calc(100% / 4); width: calc(100% / 4); background: #efefef; box-sizing: border-box; -moz-box-sizing: border-box; border: 2px solid #fff; padding: 0 1em; overflow: hidden;}
...
<div class="pismo" id="cantata-one">
	<h2>Cantata One</h2>
...
<div class="pismo" id="pt-sans-narrow">
...
<div class="pismo" id="roboto">
	<h2>Roboto</h2>
	<p class="ukazka" style="font-family: 'Roboto';"><span>ěščřžýáéňóůúďť</span><br><span>escrzyaenouudt</span></p>
</div>
