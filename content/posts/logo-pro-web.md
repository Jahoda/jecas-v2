---
title: "Jak vytvořit logo pro web"
headline: "Jak vytvořit logo pro web: kompletní průvodce"
description: "Průvodce tvorbou loga pro webové stránky. Od základních principů designu přes nástroje až po technické aspekty implementace."
date: "2026-01-26"
status: 1
tags: ["napady", "obrazky", "ux"]
format: "html"
---
...
<h3 id="lettermark">Lettermark (monogram)</h3>
...
<p>Text je integrován do symbolu. Příklady: <b>Starbucks</b>, <b>Harley-Davidson</b>, <b>NFL</b>.</p>

<p>Má tradiční vzhled, ale může být méně flexibilní při zmenšování.</p>

<h2 id="principy">Základní principy dobrého loga</h2>

<p>Při návrhu loga je dobré držet se osvědčených pravidel.</p>
...
<p>Existuje mnoho nástrojů od profesionálních po jednoduché online generátory.</p>

<h3 id="profesionalni">Profesionální nástroje</h3>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Vektorový editor</td>
            <td>Předplatné</td>
        </tr>
        <tr>
            <td><b>Affinity Designer</b></td>
            <td>Vektorový editor</td>
            <td>Jednorázová</td>
        </tr>
        <tr>
            <td><b>Figma</b></td>
            <td>Design nástroj</td>
            <td>Freemium</td>
        </tr>
        <tr>
            <td><b>Inkscape</b></td>
            <td>Vektorový editor</td>
            <td>Zdarma (open source)</td>
        </tr>
    </tbody>
</table>

<p>Pro tvorbu loga je vždy nejlepší používat <b>vektorovou grafiku</b>, která umožňuje škálování bez ztráty kvality.</p>

<h3 id="online">Online generátory</h3>
...
<p>Moderní AI nástroje mohou generovat návrhy log:</p>

<ul>
    <li><a href="https://www.recraft.ai">Recraft</a> – generuje přímo vektorovou grafiku (SVG)</li>
    <li><a href="https://www.imagine.art/image">Imagine.art</a> – AI generátor obrázků</li>
    <li><b>Midjourney</b>, <b>DALL-E</b>, <b>Stable Diffusion</b> – obecné AI generátory</li>
</ul>

<p>Pozor na to, že většina AI nástrojů generuje rastrové obrázky, které je potřeba následně převést na vektory. Výjimkou je Recraft, který umí přímo SVG. Také není zaručena unikátnost – podobný výstup může dostat i někdo jiný.</p>
...
<table>
    <thead>
        <tr>
            <th>Barva</th>
            <th>Asociace</th>
            <th>Příklady značek</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td><span style="color: #2563eb">Modrá</span></td>
            <td>Důvěra, profesionalita, klid</td>
            <td>Facebook, LinkedIn, IBM</td>
        </tr>
        <tr>
            <td><span style="color: #dc2626">Červená</span></td>
            <td>Energie, vášeň, urgence</td>
            <td>YouTube, Netflix, Coca-Cola</td>
        </tr>
        <tr>
            <td><span style="color: #059669">Zelená</span></td>
            <td>Příroda, zdraví, růst</td>
            <td>Spotify, Starbucks, WhatsApp</td>
        </tr>
        <tr>
            <td><span style="color: #eab308">Žlutá</span></td>
            <td>Optimismus, kreativita, teplo</td>
            <td>McDonald's, IKEA, Snapchat</td>
        </tr>
        <tr>
            <td><span style="color: #7c3aed">Fialová</span></td>
            <td>Luxus, kreativita, moudrost</td>
            <td>Twitch, Yahoo, Cadbury</td>
        </tr>
        <tr>
            <td><span style="color: #f97316">Oranžová</span></td>
            <td>Přátelskost, energie, mladistvost</td>
            <td>Amazon, Firefox, Fanta</td>
        </tr>
    </tbody>
</table>
...
<p>Pro textová loga je výběr písma klíčový.</p>
...
<p>Vektorový formát ideální pro web:</p>

<ul>
    <li>Škálovatelný bez ztráty kvality</li>
    <li>Malá velikost souboru</li>
    <li>Lze stylovat pomocí CSS</li>
    <li>Podporuje animace</li>
</ul>

<pre><code>&lt;img src="/logo.svg" alt="Logo společnosti" width="200" height="50"&gt;
...
<h2 id="ResponsiveLogoDesign">Responzivní logo</h2>
...
<pre><code>&lt;picture&gt;
  ...
  &lt;img src="/logo-compact.svg" alt="Logo"&gt;
&lt;/picture&gt;</code></pre>

<h2 id="checklist">Checklist před nasazením</h2>
...
<p>Čeho se vyvarovat při tvorbě loga:</p>

<ul>
    <li><b>Příliš mnoho detailů</b> – ztratí se při zmenšení</li>
    <li><b>Použití rastrové grafiky</b> – nelze škálovat</li>
    <li><b>Kopírování konkurence</b> – ztrácíte unikátnost</li>
    <li><b>Módní trendy</b> – logo rychle zastará</li>
    <li><b>Špatná čitelnost</b> – příliš tenké linky nebo nízký kontrast</li>
    <li><b>Příliš mnoho barev</b> – působí neprofesionálně</li>
</ul>
