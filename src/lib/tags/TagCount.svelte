...
<a href={tag.url_slug} class="group relative flex overflow-hidden rounded-md">
	...
	<div
		class="flex h-11 items-center justify-between gap-2 border border-white/25 pr-2 pl-4 whitespace-nowrap shadow-black drop-shadow-2xl transition-all [text-shadow:0_0_1px_rgba(0,0,0,0.4),0_4px_8px_rgba(0,0,0,0.2)] group-hover:!w-full {percent <
		0.3
			? 'text-xs'
			: ''}"
